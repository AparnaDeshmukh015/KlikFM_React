...
const InfraAssetSchedule = ({
  ...
  const onSubmit = async (payload: any, e: any) => {
    ...
    //   setIsSubmit(false);
    //   return;
    // }const weekDayValue = payload?.SCHEDULER?.WEEKLY_1_WEEKDAY;
    const weekDayValue = payload?.SCHEDULER?.WEEKLY_1_WEEKDAY;
    const arr = Array.isArray(weekDayValue) ? weekDayValue : [weekDayValue];

    if (typeof (Btnvalue === "Weekly" && payload?.SCHEDULER?.WEEKLY_1_WEEKDAY) === "object") {
      toast.error("Please fill the required fields");
      setIsSubmit(false);
      return;
    }
                        ...
                        <>
                          <div className="grid grid-cols-1 gap-x-3 gap-y-3 md:grid-cols-3 lg:grid-cols-3">
                            ...
                            <div className="col-span-2">
                              ...
                              <div
                                className={`${weekStatus === true ? "errorBorders" : "abc"
                                  }`}
